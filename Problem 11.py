...
def productFour(nums): #calculates product
    count = 1
    for i in range(4):
        count = count * nums[i]
    return count
# print(productFour(vert[0]))
...
def vertCheck(vert):
    ...
    for i in range(L):
        ...
        if t > M:
            M = t
    return M
print(vertCheck(vert), 'vertical max')
...
def horzCheck(horz):
    ...
    for i in range(L):
        ...
        if t > M:
            M = t
    return M
print(horzCheck(horz), 'horz max')
backSlash = []
for i in range(17):
    for j in range(3, 20):
        backSlash = backSlash + [[sList[i + k ][j - k] for k in range(4)]]
# print(backSlash)
if [97, 99, 49, 52] in backSlash:
    print(True)
else:
    print(False)
def backSlashCheck(backSlash):
    L = len(backSlash)
    M = 0
    for i in range(L):
        t = productFour(backSlash[i])
        if t > M:
            M = t
    return M
print(backSlashCheck(backSlash), 'back Slash max')
...
for i in range(17):
    for j in range(17):
        forSlash = forSlash + [[sList[i + k ][j + k] for k in range(4)]]
# print(forSlash)
if [8, 49, 31, 23] in forSlash:
    print(True)
else:
    print(False)
def backSlashCheck(forSlash):
    L = len(forSlash)
    M = 0
    for i in range(L):
        t = productFour(forSlash[i])
        if t > M:
            M = t
    return M
print(backSlashCheck(forSlash), 'for slash max')

ans = max(51267216, 48477312, 70600674, 40304286)
